...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_INIT" -parent ${Page_0}
...
proc update_MODELPARAM_VALUE.C_INIT { MODELPARAM_VALUE.C_INIT PARAM_VALUE.C_INIT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_INIT}] ${MODELPARAM_VALUE.C_INIT}
}

...
architecture STRUCTURE of design_2 is
  ...
  signal NLW_APU_0_address_f_UNCONNECTED : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal NLW_APU_0_address_t_UNCONNECTED : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal NLW_latch_0_x_ack_UNCONNECTED : STD_LOGIC;
begin
APU_0: component design_2_APU_0_0
     port map (
      address_ack => '0',
      address_f(1 downto 0) => NLW_APU_0_address_f_UNCONNECTED(1 downto 0),
      address_t(1 downto 0) => NLW_APU_0_address_t_UNCONNECTED(1 downto 0),
      d_f => latch_0_y0_f,
      d_t => latch_0_y0_t
    );

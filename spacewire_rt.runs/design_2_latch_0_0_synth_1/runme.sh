...
HD_PWD='G:/spacewire_rt/spacewire_rt.runs/design_2_latch_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_latch_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_latch_0_0.tcl
